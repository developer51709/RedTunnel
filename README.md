...
RedTunnel is currently in **active early development**.  
Core functionality, Cloudflare integration modules, and safe‑simulation engines are being built iteratively with a strong focus on:

- Verified domain and tunnel ownership  
- Legally compliant hostile‑traffic simulation  
- Cloudflare‑aware behavior analysis  
- Origin shielding and tunnel resilience testing  

Because this project aims to set a new standard for *safe attack simulation*, development is intentionally careful and methodical.
